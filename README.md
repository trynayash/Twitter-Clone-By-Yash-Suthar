# Fullstack Twitter Clone By Yash Suthar
...
3. Run the application
   ...
   python run.py
   ```
4. Also You Can Try Creating Venv In Your Project

5. Navigate to https://http://127.0.0.1:5000/

6. Now You can use your Application
